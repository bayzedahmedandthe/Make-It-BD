...
const Banner = () => {
    return (
        <div className="bg-gradient-to-r   from-[#ede7f7] to bg-[#fae8e8]">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center justify-center gap-4 md:py-8 py-6 md:w-11/12 mx-auto w-full">
                {/* Text Container */}
                ...
                {/* Video Container */}
                <div className="md:m-0 m-4" style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden" }}>
                    <iframe
